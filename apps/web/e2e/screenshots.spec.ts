...
const STAGES: Record<string, StageShots> = {
  ...
  '2-5': {
    solution:
      'right up up left left down down right down right right right right up right up up left down',
    shots: {
      0: 'start',
      1: 'slid-past-ladder',
      7: 'ladder-taken',
  ...
  '2-10': {
    solution:
      'down down down right right right right right up up up right right right right down down down down down down down left left down up left left left left left left down down down down',
    guide: ['guide-pushes'],
    shots: {
      0: 'start',
      6: 'box-slid-to-gap',
  ...
  '3-1': {
    solution:
      'right right right left left left left left up up up right right right right right right right down',
    guide: ['guide-crack'],
    shots: {
      0: 'start',
      1: 'stepped-on-crack',
  ...
  '3-2': {
    solution:
      'right right right right right up up up up right right right right right right down down left left left left left left left',
    shots: {
      0: 'start',
      5: 'fell-in-pit',
      8: 'box-pushed-collapsed',
      9: 'on-box',
      16: 'zone-changed',
      23: 'refilled-and-cleared',
    },
  },
  '3-3': {
    solution:
      'right right down down left left down down right right right right right right left left down down down right right down down down left left left left up up right',
    shots: {
      0: 'start',
      4: 'fell-in-pit',
      8: 'ladder-taken',
  ...
  '3-4': {
    solution:
      'up up left up left left left left down left down right right right right right right right',
    guide: ['guide-warp'],
    shots: {
      0: 'start',
      2: 'before-warp',
